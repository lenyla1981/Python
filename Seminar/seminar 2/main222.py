...
#Цельсия. Напишите программу, помогающую синоптикам в работе.Пользователь вводит число N – общее 
#количество рассматриваемых дней (1 ≤ N ≤ 100). В следующих строках располагается N целых чисел.
...
max_count=0
for i in gange(n):
    temp=int(input('Enter number from -50 to 50'))
    if temp>0:
        count+=1
        if max_count<count:
             max_count=count
